...
def main(db_file, exac_files, protein_lengths):
    ...
    if exac_files is not None:
        ...
        db.execute('''CREATE TABLE if not exists exac (gene text, impact text, impact_type text, allele_count int, total_alleles int, exac_all real, exac_african real, exac_latino real, exac_east_asian real, exac_fin real, exac_nonfin_eur real, exac_south_asian real, exac_other real, cadd read, cadd_indel real, condel real, sift real, polyphen real)''')
